...
exports.handler = (event, context, callback) => {
  ...
  pool.getConnection(function (err, connection) {
    ...
    var sqlQuery = `SELECT i.id as item_id, i.customer_id,c.email_id as email_id, item_name,i.description,baby_age,i.condition,brand,DATE_FORMAT(lease_startDT, '%m/%d/%Y') as lease_startDT, DATE_FORMAT(lease_endDT, '%m/%d/%Y') as lease_endDT, ` +
